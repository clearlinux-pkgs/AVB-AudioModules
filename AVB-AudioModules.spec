...
Version  : 4.1.0
Release  : 3
URL      : https://github.com/intel/AVB-AudioModules/archive/v4.1.0.tar.gz
Source0  : https://github.com/intel/AVB-AudioModules/archive/v4.1.0.tar.gz
...
%prep
%setup -q -n AVB-AudioModules-4.1.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1542372784
mkdir -p clr-build
pushd clr-build
...
cp LICENSE.txt %{buildroot}/usr/share/package-licenses/AVB-AudioModules/LICENSE.txt
pushd clr-build
%make_install
popd
...
/usr/lib64/libias-audio-common.so.4.1.0

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/AVB-AudioModules/LICENSE.txt
